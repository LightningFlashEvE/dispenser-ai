...
from app.services.inventory.drug_lookup import drug_to_dict, find_best_drug, fuzzy_score
...
async def _handle_cancel_current_task(
    client_id: str,
...
async def voice_websocket(websocket: WebSocket) -> None:
    ...
    try:
        ...
        while True:
            ...
            if msg_type == "cancel":
                await _handle_cancel_current_task(client_id, state_machine, control_client)
